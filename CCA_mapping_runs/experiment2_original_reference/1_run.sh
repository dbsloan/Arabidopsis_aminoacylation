...
for file in *1.fq.gz; do bbmerge.sh in1=$file in2=${file%1.fq.gz}2.fq.gz out=${file%_CKDL240012453-1A_HCHFJDSXC_L4_1.fq.gz}.bbmerge.fq outu=${file%_CKDL240012453-1A_HCHFJDSXC_L4_1.fq.gz}.unmerged1.fq outu2=${file%_CKDL240012453-1A_HCHFJDSXC_L4_1.fq.gz}.unmerged2.fq ihist=${file%_CKDL240012453-1A_HCHFJDSXC_L4_1.fq.gz}.bbmerge_hist.txt ordered=t qtrim=r minoverlap=30 mismatches=4 2> ${file%_CKDL240012453-1A_HCHFJDSXC_L4_1.fq.gz}.bbmerge_log.txt; done
